...
<head>
    ...
    <!-- Tambahan Disini -->
    <link href="<?= base_url('app/') ?>plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- Tambahan Disini -->
...
<body class="fix-header">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title text-center">Grafik Harian Perbandingan Permohonan SKCK Online, Offline dan Jumlah Cetak Bulan April Tahun 2020</h3>
                            <ul class="list-inline text-right">
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #00bfc7;"></i>Online</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #fdc006;"></i>Offline</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #9675ce;"></i>Cetak</h5>
                                </li>
                            </ul>
                            <div id="harian"></div>
                        </div>
    ...
    <script src="<?= base_url('app/') ?>plugins/bower_components/raphael/raphael-min.js"></script>
    <script src="<?= base_url('app/') ?>plugins/bower_components/morrisjs/morris.js"></script>
    <script src="<?= base_url('app/') ?>pages/dashboard.js"></script>
</body>
